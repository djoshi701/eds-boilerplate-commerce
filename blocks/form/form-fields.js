...
// Utility function to set multiple attributes
...
const createSelect = async (fd) => {
  ...
  setAttributes(svg, {
    ...
    viewBox: '0 0 24 24',
    class: 'dropin-icon dropin-icon--shape-stroke-2 dropin-picker__chevronDown',
  });

  // Create the path element for SVG
  ...
  selectWrap.classList.add('select-main-wrapper');
  const fieldWrapper = createFieldWrapper(fd);
  selectWrap.append(select);
  selectWrap.append(svg);
  fieldWrapper.append(selectWrap);
